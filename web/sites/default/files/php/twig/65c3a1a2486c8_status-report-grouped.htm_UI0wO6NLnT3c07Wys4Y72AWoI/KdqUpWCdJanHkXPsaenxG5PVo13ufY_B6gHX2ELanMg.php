...
class __TwigTemplate_80645472fb92f7f6234d89cef1fa5156 extends Template
{
    private $source;
    private $macros = [];
...
<div>
  ";
      ...
      ";
          ...
          ";
                // line 28
                $context["summary_classes"] = ["system-status-report__status-title", ((twig_in_filter(twig_get_attribute($this->env, $this->source,                 // line 30
$context["group"], "type", [], "any", false, false, true, 30), ["warning", "error"])) ? (("system-status-report__status-icon system-status-report__status-icon--" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["group"], "type", [], "any", false, false, true, 30), 30, $this->source))) : (""))];
                // line 33
                echo "          <summary";
